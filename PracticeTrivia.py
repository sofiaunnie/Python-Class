...
def lifestyle_trivia():
    lifestyle = [
        ...
        ("Via San Gregorio Armeno, a street with many makers of traditional wooden nativity scenes, is in which city?: ","C"),
...
while category1 == "1" and category2 == "2":
...
while category4 not in pick12.keys():
    print('invalid input! please enter a valid category')
    category4 = (input("Pick a valid category: "))
